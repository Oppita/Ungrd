...
export const AddOtrosieForm: React.FC<AddOtrosieFormProps> = ({ contracts, onClose }) => {
  ...
  const handlePdfUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setIsParsing(true);
    setParseProgress('Analizando documento con RIGOR IA (procesando imágenes para mayor exactitud)...');
    ...
    try {
      ...
      console.log(`Iniciando análisis de RIGOR IA para ${formType}...`);
      const extractionResult = await analyzeDocumentWithRigor(file, prompt);
      const extractedData = extractionResult.data;
      
      console.log('Datos extraídos con RIGOR IA:', extractedData);
      ...
      setParseProgress('Análisis completado con éxito (Rigor IA).');
